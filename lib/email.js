      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="payment-section">
            ...
            <p><strong>Problemas para pagar?</strong> <a href="mailto:${LOJA_EMAIL}">Entre em contato conosco</a> — estamos aqui para ajudar***REMOVED***</p>
          </div>
          ` : `
          <div>
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <p>Qualquer dúvida, estamos aqui para ajudar***REMOVED***</p>
          <div class="footer">
            <p>Equipe ${LOJA_NOME}</p>
          </div>
        </div>
...
function templateAvisoUltimoDia(nomeCliente, dataVencimento, plano, valor) {
  ...
  return `
    ...
    <body>
      <div class="container">
        <div class="header">
          <h2>🚨 AMANHÃ Sua Assinatura Vence***REMOVED***</h2>
        </div>
        <div class="content">
          <p>Oi ${nomeCliente},</p>
          <div class="alert">
          ...
          <p>Quer cancelar ou mudar de plano? <a href="mailto:${LOJA_EMAIL}">Entre em contato agora</a> — você ainda está a tempo***REMOVED***</p>
