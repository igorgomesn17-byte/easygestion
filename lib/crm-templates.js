...
//
// ATENCAO AO CUPOM: e' TEXTO na mensagem, nao motor. O sistema nao tem tabela de
// cupom nem valida codigo no PDV. Na loja original o "VOLTE20" era combinado verbal
// com a cliente. Nao construir em cima disto sem antes decidir fazer o motor.
// ============================================================
...
const VARIAVEIS_DISPONIVEIS = [
  ...
  '{selos}', '{faltam}', '{dias}',
  '{cupom}', '{cupom_pct}', '{cupom_dias}', '{produto}',
];

module.exports = {
  DEFAULT_TEMPLATES, TEMPLATES_SEGMENTO, ROTULOS, VARIAVEIS_DISPONIVEIS, interpolar,
};
