...
const SLUGS_RESERVADOS = new Set([
  ...
  'landing', 'index', 'js', 'css', 'public', 'api-docs', 'thumbs.db',
  // Segmentos internos da loja online (/:slug/p/:peca, /:slug/pedido/:codigo).
  // Sem isso, uma loja com slug 'p' tornaria /p/vestido-142 ambíguo — a rota da
  // peça e a home daquela loja disputariam a mesma URL. Verificado antes de
  // reservar: nenhum tenant usa esses nomes.
  'p', 'pedido', 'pedidos', 'carrinho', 'busca'
]);
