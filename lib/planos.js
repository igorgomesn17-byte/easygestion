...
const PLANOS = {
  starter: {
    ...
    features: { vale_credito: false, recorrentes: false, export: false, relatorios_avancados: false, vitrine_publica: false, personalizacao: false, precificacao: false, maquininha: false, maquininha_integrada: false, relacionamento: false, multiplas_lojas: false, api: false },
  },
  growth: {
    id: 'growth',
    nome: 'Growth',
    ...
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, personalizacao: true, precificacao: true, maquininha: true, maquininha_integrada: false, relacionamento: false, multiplas_lojas: false, api: false },
  },
  enterprise: {
    id: 'enterprise',
    nome: 'Enterprise',
    ...
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, personalizacao: true, precificacao: true, maquininha: true, maquininha_integrada: false, relacionamento: true, multiplas_lojas: true, api: true },
  },
  ...
  // É aqui que mora o Relacionamento (régua + RFM + clube) e a maquininha
  // integrada enquanto não viram produto: quando virarem, basta ligar
  // relacionamento:true / maquininha_integrada:true no growth.
  interno: {
    id: 'interno',
    ...
    preco_anual: 0,
    limites: { produtos: Infinity, usuarios: Infinity },
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, personalizacao: true, precificacao: true, maquininha: true, maquininha_integrada: true, relacionamento: true, multiplas_lojas: true, api: true },
  },
};
