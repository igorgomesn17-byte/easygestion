...
const PLANOS = {
  starter: {
    ...
    features: { vale_credito: false, recorrentes: false, export: false, relatorios_avancados: false, vitrine_publica: false, multiplas_lojas: false, api: false },
  },
  growth: {
    id: 'growth',
    nome: 'Growth',
    ...
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, multiplas_lojas: false, api: false },
  },
  enterprise: {
    id: 'enterprise',
    nome: 'Enterprise',
    ...
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, multiplas_lojas: true, api: true },
  },
};
