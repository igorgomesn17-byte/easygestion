...
const PLANOS = {
  starter: {
    ...
    features: { vale_credito: false, recorrentes: false, export: false, relatorios_avancados: false, vitrine_publica: true, vitrine_site: false, personalizacao: true, precificacao: true, maquininha: false, maquininha_integrada: false, base_importada: false, relacionamento: false, multiplas_lojas: false, api: false },
  },
  growth: {
    id: 'growth',
    nome: 'Growth',
    ...
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, vitrine_site: false, personalizacao: true, precificacao: true, maquininha: true, maquininha_integrada: false, base_importada: false, relacionamento: true, multiplas_lojas: false, api: false },
  },
  enterprise: {
    id: 'enterprise',
    nome: 'Enterprise',
    ...
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, vitrine_site: false, personalizacao: true, precificacao: true, maquininha: true, maquininha_integrada: false, base_importada: false, relacionamento: true, multiplas_lojas: true, api: true },
  },
  ...
  interno: {
    ...
    preco_anual: 0,
    limites: { produtos: Infinity, usuarios: Infinity },
    features: { vale_credito: true, recorrentes: true, export: true, relatorios_avancados: true, vitrine_publica: true, vitrine_site: true, personalizacao: true, precificacao: true, maquininha: true, maquininha_integrada: true, base_importada: true, relacionamento: true, multiplas_lojas: true, api: true },
  },
};
