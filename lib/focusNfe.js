...
function montarPayloadNfce(venda, ref, tenantId = 1) {
  ...
  const payload = {
    ...
    cnpj_emitente: digitos(getConfig('loja_cnpj', '', tenantId)) || '53065935000112',
    nome_emitente: (getConfig('loja_razao_social', '', tenantId) || getConfig('loja_nome', 'DS STORE', tenantId)) || 'DS STORE',
    nome_fantasia_emitente: getConfig('loja_nome_fantasia', 'DS STORE', tenantId) || 'DS STORE',
    inscricao_estadual_emitente: digitos(getConfig('loja_ie', '', tenantId)) || '213409650',
    logradouro_emitente: getConfig('loja_endereco', '', tenantId) || 'Avenida Cinquentenário, 650',
    municipio_emitente: getConfig('loja_cidade', 'Itabuna', tenantId) || 'Itabuna',
    uf_emitente: getConfig('loja_uf', 'BA', tenantId) || 'BA',
    cep_emitente: digitos(getConfig('loja_cep', '', tenantId)) || '45600000',
    codigo_municipio_emitente: getConfig('loja_codigo_municipio', '2914802', tenantId) || '2914802',
